...
export default function EditorPage({ data }) {
  ...
  if (isConnected) {
    return (
      <div>
        <Head>
          <title>LoopoKrator - Editor</title>
          ...
          <div className="page-content">
            ...
            <div className="welcome-message">
              <p className="welcome-message-text">
                Get <span className="important-text">creative!</span>
              </p>
              {/* <p className="welcome-message-text">
                {process.env.NEXT_PUBLIC_MESSAGE}
              </p> */}
            </div>
            <div className={styles.editor_inputs}>
              <InputField
                className="loopokrator-text-input"
                type="text"
                dataLabel="Article Title"
              />
              <Select
              ...
              <TinyEditor
                ...
                options={{
                  ...
                  extended_valid_elements: [
                    "img[class=article-cover-image|src|border=0|alt|title|hspace|vspace|align|onmouseover|onmouseout|name]",
                  ],

                  menubar: false,
                }}
              />
              <TinyEditor title="Article Body" />
              <CheckBox label="Publish Article" />
              <button className="loopokrator-btn" onClick={uploadArticle}>
                Upload Article
              </button>
            </div>
          </div>
